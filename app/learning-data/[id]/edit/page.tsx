...
export default function EditRoutePage() {
  ...
  return (
    // 💡 max-w-md から max-w-3xl に広げ、他の管理ダッシュボードとサイズ・丸みを完全統一！
    <div className="p-6 max-w-3xl mx-auto bg-gray-50 min-h-screen pb-24 rounded-3xl shadow-sm border border-gray-100 mt-4 space-y-6">
      ...
      <div className="flex items-center justify-between border-b border-gray-100 pb-4">
        ...
        <h1 className="text-base font-black text-gray-800">ルート編集</h1>
        <div className="w-16"></div>
      </div>

      {/* 💡 PC時は「入力フォーム」と「参考書のドラッグ＆追加」が左右綺麗な2カラムに分かれます！ */}
      <form onSubmit={handleUpdateRoute} className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
        ...
        <div className="bg-white p-5 rounded-2xl border border-gray-100 shadow-sm space-y-4 h-full">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="このルートを進める上でのアドバイスや注意点を書こう！"
              rows={4}
        ...
        <div className="md:col-span-2 pt-2">
          ...
          >
            ...
            {loading ? 'ルートを更新中...' : '参考書ルートの変更を保存する'}
          </button>
        </div>
