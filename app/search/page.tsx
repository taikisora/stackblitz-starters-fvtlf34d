    ...
    <div className="p-6 max-w-3xl mx-auto bg-gray-50 min-h-screen pb-24 rounded-3xl shadow-sm border border-gray-100 mt-4">
      ...
      {searchStep === 'menu' && (
        <div className="space-y-6">
          ...
          {/* md:grid-cols-4 を追加してPCでは4列に */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <MenuCard icon={<Pencil className="text-orange-500" />} title="教科" bgColor="bg-orange-50/60 hover:bg-orange-100/70" onClick={openRegularSubjectFilter} />
            <MenuCard icon={<Bookmark className="text-green-500" />} title="出版社" bgColor="bg-green-50/60 hover:bg-green-100/70" onClick={openPublisherFilter} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4">
            ...
            <div className="bg-gradient-to-br from-white to-gray-50/50 p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between hover:shadow-md transition-shadow group">
              ...
              <button onClick={openTextbookFilter} className="mt-6 w-full bg-indigo-50 text-indigo-700 font-bold py-3 px-4 rounded-xl text-sm flex items-center justify-center gap-2 hover:bg-indigo-100 transition-colors">
            ...
            <div className="bg-gradient-to-br from-white to-gray-50/50 p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between hover:shadow-md transition-shadow group">
              ...
              <button onClick={() => openExamFilter('共通テスト')} className="mt-6 w-full bg-sky-50 text-sky-700 font-bold py-3 px-4 rounded-xl text-sm flex items-center justify-center gap-2 hover:bg-sky-100 transition-colors">
            ...
            <div className="bg-gradient-to-br from-white to-gray-50/50 p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between hover:shadow-md transition-shadow group">
              ...
              <button onClick={() => openExamFilter('私大・2次')} className="mt-6 w-full bg-rose-50 text-rose-700 font-bold py-3 px-4 rounded-xl text-sm flex items-center justify-center gap-2 hover:bg-rose-100 transition-colors">
