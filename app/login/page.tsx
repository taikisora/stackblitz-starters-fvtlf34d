...
export default function LoginPage() {
  ...
  const handleAppleLogin = async () => {
    ...
    if (error) {
      setMessage('Appleログインに失敗しました: ' + error.message);
      setLoading(false);
    }
  };
          ...
          <div className="mt-6">
            ...
            <div className="space-y-3">
              ...
              <button
                  ...
                  disabled={loading}
                  className="w-full bg-black text-white font-bold py-3 rounded-xl hover:bg-gray-800 transition-colors flex items-center justify-center shadow-sm disabled:bg-gray-400 cursor-pointer"
                >
                  {/* Appleのロゴ（SVG） */}
                  <svg className="w-5 h-5 mr-3 fill-current" viewBox="0 0 384 512" xmlns="http://www.w3.org/2000/svg">
