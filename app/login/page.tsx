        ...
        {!isOtpMode && !isResetMode && (
          <div className="mt-6">
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-white border border-gray-300 text-gray-700 font-bold py-3 rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center shadow-sm disabled:bg-gray-100 disabled:text-gray-400"
            >
              {/* GoogleのGマーク（SVG） */}
