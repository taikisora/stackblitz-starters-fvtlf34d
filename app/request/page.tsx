...
export default function RequestPage() {
  ...
  return (
    <div className="p-4 max-w-md mx-auto bg-white min-h-screen pb-24">
      ...
      <h1 className="font-extrabold text-gray-900 text-xl mb-6 px-1">
        リクエスト・ご意見
      </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              rows={5}
              className="w-full text-sm border border-gray-200 rounded-xl p-3 bg-gray-50 focus:outline-none focus:border-blue-500 focus:bg-white transition-all min-h-[120px]"
            />
          </div>
